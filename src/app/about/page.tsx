              ...
              <div className="space-y-6 mt-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-background/50 p-6 rounded-lg border border-gray-100 dark:border-gray-800">
                    ...
                    <p className="text-muted-foreground">
                      Ask questions about your documents and receive accurate, contextual answers that aim to deepen your understanding. Coeus understands your materials and provides relevant information aimed towards developing your comprehension of any topic you seek to learn.
                    </p>
                  </div>
                  ...
                  <div className="bg-background/50 p-6 rounded-lg border border-gray-100 dark:border-gray-800">
                    ...
                    <p className="text-muted-foreground">
                      Access a variety of specialized tools designed to enhance your learning experience, from catered practice questions to in-depth explanations of concepts.
                    </p>
                  </div>
                </div>
              </div>
